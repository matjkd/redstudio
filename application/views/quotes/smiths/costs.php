...
<ul>
	...
	<li><i class="icon-ok"></i> Menu Page (£100)</li>
	<li><i class="icon-ok"></i> Other basic pages (£100 each)</li>
</ul>

<p>The site will include the facility to sign up to a email newsletter. An email marketing service such as <a target="_blank" href="http://www.mailchimp.com">Mailchimp</a> or similar
